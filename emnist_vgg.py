...
batch_size = 16  # Сильно уменьшим размер батча для VGG, она требует много памяти
...
# Инициализация облегченной модели VGG
def initialize_vgg16():
    # Используем VGG11 вместо VGG16 для экономии памяти
    model = models.vgg11(weights=None)
    
    # Уменьшим размер батча для экономии памяти
    # Если у вас по-прежнему будет ошибка OOM, можно использовать меньший размер изображений
